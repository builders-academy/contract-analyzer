...
#         return Task(
#             description=dedent(f"""
#                 Create mermaidjs code showing control flow within the contract and between contracts using the following contract code and functions:
#                 Here's the contract code:
#                 {contract_code}
#                 and here's its function:
#                 {contract_functions} 
#                 Return the mermaidjs code as a string and store it in shared memory 'diagram'.
#             """),
